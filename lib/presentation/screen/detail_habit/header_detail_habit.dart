  ...
  Widget _buildContainerCheck() {
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            SizedBox(height: !_state.habit.isFinished ? 220.0 : 180),
            Image.asset(
              kImageTag,
              width: 160.0,
              height: 160.0,
            ...
            if (!_state.habit.isFinished)
              ConfirmationSlider(
                onConfirmation: () async {
                  ...
                  _detailHabitBloc
                      .add(AddDiary(DiaryItem(text: result, images: [])));
                },
                height: 56.0,
                text: '',
            ...
            if (_state.habit.typeHabitGoal ==
                EHabitGoal.reachACertainAmount.index)
              Text(
                "0/${_state.habit.totalDayAmount} ${kHabitMissionDayUnit[_state.habit.missionDayUnit]}",
